...
public class CloudscapeDataAccess 
   ...
   private PreparedStatement sqlInsertAltAddress;
   ...
   private PreparedStatement sqlUpdateAltAddress;
   ...
   public CloudscapeDataAccess() throws Exception
   {
      ...
      sqlInsertAltAddress = connection.prepareStatement(
              "INSERT INTO addresses ( personID, altAddress1, " +
                      "ltAaddress2, altCity, altCounty ) " +
                      "VALUES ( ? , ? , ? , ? , ? )" );
      ...
      sqlUpdateAddress = connection.prepareStatement(
         "UPDATE addresses SET address1 = ?, address2 = ?, " +
            "city = ?, county = ? " +
         "WHERE addressID = ?" );
      sqlUpdateAltAddress = connection.prepareStatement(
              "UPDATE addresses SET altAddress1 = ?, altAddress2 = ?, " +
                      "altCity = ?, altCounty = ? " +
                      "WHERE addressID = ?");
   ...
   public AddressBookEntry findPerson( String lastName )
   {
      try {
         ...
         person.setAltAddress1( resultSet.getString( 13 ) );
         person.setAltAddress2( resultSet.getString( 14 ) );
         person.setAltCity( resultSet.getString( 15 ) );
         person.setAltCounty( resultSet.getString( 16 ) );
      ...
      throws DataAccessException
   {
      ...
      try {
         ...
         sqlUpdateAltAddress.setString(1,person.getAltAddress1());
      ...
      try {
         ...
         if ( resultPersonID.next() ) {
            ...
            sqlInsertAddress.setString( 5, 
               person.getCounty() );
            sqlInsertAltAddress.setString(2,person.getAltAddress1());
